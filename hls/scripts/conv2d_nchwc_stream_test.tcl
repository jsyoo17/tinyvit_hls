# hls/scripts/conv2d_nchwc_stream_test.tcl
# Run from repo root:
#   vitis_hls -f hls/scripts/conv2d_nchwc_stream_test.tcl
...
set proj_name      "conv2d_nchwc_stream_test"

# Top-level function name in your C/C++ source
set top_name       "conv2d_nchwc_stream"
...
set design_sources {
    "conv2d_cfg.hpp"
    "conv2d_stream_types.hpp"
    "conv2d_nchwc_stream.cpp"
}

# Testbench source files (relative to hls/tb/)
set tb_sources {
    "tb_conv2d_nchwc_stream.cpp"
}
